# vscode-openai (Repository Deprecation Notice)

Please note that this repository has been deprecated. The project has transitioned to an open-source model and the latest version can now be accessed at our new location: https://github.com/arbs-io/vscode-openai

We encourage all contributors and users to visit the new repository for the most recent updates, bug fixes, and features. Thank you for your understanding and continued support.
